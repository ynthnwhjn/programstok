/******/ (() => { // webpackBootstrap
/*!*****************************************************!*\
  !*** ./resources/views/customers/customers_form.js ***!
  \*****************************************************/
(function () {
  'use strict';

  angular.module('app').controller('CustomerFormController', CustomerFormController);
  function CustomerFormController($scope, $http, toastr) {
